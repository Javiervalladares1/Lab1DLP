...
Se agregaron estos archivos en `workspace/examples`:

-   `java_identifiers.l` (inciso 1)
-   `lab1_lexer.l` (incisos 2, 3, 4 y 5)
-   `tests/identificadores_input.txt`
-   `tests/lab1_input.txt`
-   `tests/test_javascript.js` (inciso 6)
-   `run_lab1.sh` (compila y ejecuta todas las pruebas)
